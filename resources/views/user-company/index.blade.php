                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('user-companies.destroy',$userCompany->id_users) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('user-companies.show',$userCompany->id_company) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('user-companies.edit',$userCompany->id_company) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
