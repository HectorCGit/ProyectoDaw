...
<body>
 <footer>
     <nav class="navbar navbar-expand-md navbar-light bg-dark shadow-sm text-white align-content-center" >
        <div>
            ...
            <div>
                ...
                <div>
                    <ul>
                        <li><a href="" class="text-warning">Política de Privacidad</a></li>
                        <li><a href="" class="text-warning">Política de Cookies</a></li>
                        <li><a href="" class="text-warning">Aviso Legal</a></li>
                    </ul>
                </div>
            </div>
        </div>
